...
plt.savefig("BH_anti_ElasticOrtho_Youngs_Modulus_Polar_All.png", dpi=600)
#%%
# # 3D Polar Plot
...
# Fixed normalization scale from 10 to 25 GPa
norm = colors.Normalize(vmin=10, vmax=25)
cmap = cm.turbo  # vibrant colormap

surf = ax.plot_surface(x, y, z, facecolors=cmap(norm(r)), edgecolor='none', linewidth=0, antialiased=True, shade=True)

# Add colorbar
mappable = cm.ScalarMappable(norm=norm, cmap=cmap)
mappable.set_array([])
cbar = plt.colorbar(mappable, shrink=0.6, aspect=10)
# Set ticks at every 5 GPa
cbar.set_ticks(np.arange(10, 26, 5))
...
plt.savefig("BH_anti_Youngs_Modulus_Polar_3D_color_bar.png", dpi=600, bbox_inches='tight', transparent=True)
...
plt.savefig("BH_anti_ElasticOrtho_Shear_Modulus_Polar_All.png", dpi=600)
